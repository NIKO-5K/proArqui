...
HD_PWD='C:/Users/njimenezs/labs/prueba_sumador/prueba_sumador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log deco7segbasicABCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source deco7segbasicABCD.tcl
