...
HD_PWD='C:/Users/njimenezs/labs/prueba_sumador/prueba_sumador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log deco7segbasicABCD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source deco7segbasicABCD.tcl -notrace
