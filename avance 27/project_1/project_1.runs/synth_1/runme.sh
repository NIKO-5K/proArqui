...
HD_PWD='C:/Users/njimenezs/Documents/labs/avance 27/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log displayControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source displayControl.tcl
